...
''')
    ...
    st.write('Otherwise, if you prefer to point out its characteristics yourself, select "Prediction from characteristics".')
    ...
    with st.expander('A peek into the process'):
        ...
        st.write('Once the characteristics of the given diamond are determined, a supervised machine learning model trained with a larger pool of diamonds decides the price.')
        ...
        st.write('- Mean absolute percentage error (mape):  0.061')
